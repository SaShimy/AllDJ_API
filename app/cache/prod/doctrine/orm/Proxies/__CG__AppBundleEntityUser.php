...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'age', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'gender', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'birthday', 'avatar', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'followedRooms', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function removeRoom(\AppBundle\Entity\UserRoomFollow $followedRooms)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRoom', [$followedRooms]);

        return parent::removeRoom($followedRooms);
    }
    ...
    public function getFollowedRooms()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFollowedRooms', []);

        return parent::getFollowedRooms();
    }
