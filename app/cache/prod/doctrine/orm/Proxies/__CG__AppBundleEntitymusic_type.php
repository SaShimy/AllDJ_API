 ...
 */
class music_type extends \AppBundle\Entity\music_type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\music_type' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\music_type' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\music_type' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\music_type' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\music_type' . "\0" . 'rooms'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (music_type $proxy) {
